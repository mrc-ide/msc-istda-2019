...
Though effective medicines for high blood pressure exist (ACE inhibitors, ARBs, calcium channel blockers),^3^ lifelong treatment to reduce blood pressure are expensive for the health system and may be undesirable for patients. Previous research has suggested several mutable lifestyle factors that are associated with high blood pressure and may be targets for intervention for persons wishing to reduce their blood pressure. Targeting precise public health promototion required identification of which lifestyle factors are most strongly and directly related to high blood pressure in the American population.
...
* Identify key recommendaions from your study for advanced scientific understanding, public health policy or practice, and future research priorities.
